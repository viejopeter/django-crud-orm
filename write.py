...
def write_instructors():
    ...
    instructor_yan = Instructor(first_name='Yan', last_name='Luo', dob=date(1962, 7, 16), full_time=True,
                                total_learners=30050)
    instructor_yan.save()

    instructor_joy = Instructor(first_name='Joy', last_name='Li', dob=date(1992, 1, 2), full_time=False,
...
def write_learners():
    ...
    learner_pan = Learner(first_name='Pan', last_name='Smith', dob=date(1999, 6, 12),
                          occupation='developer',
                          social_link='https://www.linkedin.com/pan')
    learner_pan.save()
